...
/**
 * 缩略档的长边。消息流里显示的就是它，**不再升级到主图**——一屏九张图各下一张 2048 的主图
 * 是几 MB，而这台服务器的出口是所有人共用的 260 KB/s。720 在视网膜屏上放到 360 点宽还是清楚的。
 */
export const THUMB_EDGE = 720
/** 算 ThumbHash 之前把图缩到这么小。官方约定长边不超过 100 */
export const BLUR_EDGE = 100
/** 头像：方形，这个边长 */
